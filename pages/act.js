...
const VideoPage2024 = () => <div>영상 없음(페이지 삭제 예정)</div>;

// 모둠구성 페이지
const GroupPage2023 = () => <div>GroupPage2023 준비중</div>;

const GroupPage2024 = () => <div>GroupPage2024 준비중</div>;

// 활동결과 페이지
const ResultPage2023 = () => <div>ResultPage2023 준비중</div>;

const ResultPage2024 = () => <div>ResultPage2024 준비중</div>;
...
export default function Home() {
      ...
      subCategories: [
        {
          ...
          year: 2023,
          name: "2023",
          component: <VideoPage2023 />,
        },
        {
          id: "video2",
          year: 2024,
          name: "2024",
          component: <VideoPage2024 />,
        },
      ],
    },
    {
      ...
      subCategories: [
        {
          ...
          year: 2023,
          name: "2023",
          component: <GroupPage2023 />,
        },
        {
          id: "group2",
          year: 2024,
          name: "2024",
          component: <GroupPage2024 />,
        },
      ],
    },
    {
      ...
      subCategories: [
        {
          ...
          year: 2023,
          name: "2023",
          component: <ResultPage2023 />,
        },
        {
          id: "result2",
          year: 2024,
          name: "2024",
          component: <ResultPage2024 />,
        },
      ],
    },
  ];
  ...
  ); // 기본값으로 첫 번째 하위 카테고리 설정

  // 상위 카테고리 변경 핸들러
  const handleCategoryChange = (categoryId) => {
    setSelectedCategory(categoryId);
    const firstSubCategory = categories.find((cat) => cat.id === categoryId)
      .subCategories[0];
          ...
          {categories
            ...
            .subCategories.map((subCategory) => (
              <button
                ...
                key={subCategory.id}
                onClick={() =>
                  handleSubCategoryClick(subCategory.id, subCategory.year)
                }
              >
                {subCategory.name}
              </button>
